export const courses = {
  mama: {
    ...
    description:
      "Ganzheitliche Bewegung & Wohlbefinden in der Schwangerschaft mit professioneller Begleitung in deiner Nähe.",
    ...
    process: [
      {
        title: "Warm-up",
        description:
          "Wir starten mit sanften Aufwärmübungen, die deinen Körper optimal auf das Training vorbereiten.",
      },
      {
        title: "Aquafitness",
        description:
          "Speziell für Schwangere angepasste Übungen, die deinen Körper stärken ohne ihn zu belasten.",
      },
      {
        title: "Entspannung",
        description:
          "Zeit zum Entspannen und die wohltuenden Effekte des Wassers zu genießen.",
      },
      {
        title: "Austausch",
        description:
          "Gemeinsame Zeit mit anderen werdenden Mamas für Gespräche und Erfahrungsaustausch.",
      },
    ],
    prices: [
      {
  ...
  baby: {
    ...
    description:
      "Spielerische Wassergewöhnung und Förderung der Motorik für Babys zwischen 3 und 12 Monaten.",
    heroImage: "/aquafit-hero.png",
    ...
    benefits: [
      {
        title: "Frühförderung",
        description:
          "Unterstützt die motorische und geistige Entwicklung deines Kindes spielerisch.",
        icon: "growth",
      },
      {
        title: "Sicherheit",
        description:
          "Lerne sichere Griffe und Haltetechniken für entspanntes Baden.",
        icon: "shield",
      },
      {
        title: "Bindung stärken",
        description:
          "Intensive 1:1 Zeit und Körperkontakt vertiefen eure Beziehung.",
        icon: "heart",
      },
      {
        title: "Soziale Kontakte",
        description:
          "Erste Begegnungen mit anderen Babys in kleiner, ruhiger Gruppe.",
        icon: "users",
      },
      {
        title: "Wasserspaß",
        description:
          "Freude am Element Wasser entdecken – ohne Zwang und Druck.",
        icon: "smile",
      },
    ],
    testimonial: {
    ...
    process: [
      ...
      },
      {
        ...
        description:
          "Zeit zum selbstständigen Entdecken (mit Schwimmhilfen) und Plantschen.",
      },
      {
        title: "Abschluss",
    ...
    prices: [
      {
        ...
        features: [
          "8 Termine à 35 Min.",
          "Geschlossener Kurs (fester Start/Ende)",
          "Eintritt inklusive",
        ],
        highlight: true,
      },
    ...
    location: {
      ...
      details: ["12:00 - 12:35 Uhr", "12:40 - 13:15 Uhr", "13:20 - 13:55 Uhr"],
    },
  },
};
